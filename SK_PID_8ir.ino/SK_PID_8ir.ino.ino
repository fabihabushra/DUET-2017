...
int blackLimit[sensorNum]={190,210,210,210,210,210,150,190};
...
//surface is set to white by default
int surface = 0;
...
{  
   ...
   //Zigzag right turn
   if (sensorValue == 0b00011010) mappedValue = 60;      //changed from 0 to 50
  else if (sensorValue == 0b00011011) mappedValue = 60; 
  ...
  //90 deg left turn
  else if (sensorValue == 0b11111000) mappedValue = -60;         
  
  //Zigzag left turn
  else if (sensorValue == 0b01011000) mappedValue = -60;   //changed from 0 to -50
  else if (sensorValue == 0b11011000) mappedValue = -60;
  
}
else if(surface == 1)
{  
  //Zigzag right turn
   if (sensorValue == 0b11100101) mappedValue = 60;      //changed from 0 to 50
  else if (sensorValue == 0b11100100) mappedValue = 60; 
  ...
  //Zigzag left turn
  else if (sensorValue == 0b10100111) mappedValue = -60;   //changed from 0 to -50
  else if (sensorValue == 0b00100111) mappedValue = -60;
