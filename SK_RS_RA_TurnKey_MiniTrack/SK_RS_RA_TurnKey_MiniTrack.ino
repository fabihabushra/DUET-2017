...
#define maxSpeed 100
int x = 350;
int blackLimit[sensorNum]={300, 250, x, x, x, x, x, 300};
...
||(sensorValue == 0b00000110)) 
    {
      surface = 0;
      if(surfChange==1) turnKey=1;
    }
if(surface == 0)
{  

   //Zigzag right turn
   if (sensorValue == 0b00011010 || sensorValue == 0b00011011 || sensorValue == 0b00111011 || sensorValue == 0b00111010 ) {mappedValue = 70; acuteKey = 1;}       //changed from 60 to 70 
  ...
  //90 deg left turn
  else if (sensorValue == 0b11111000 || sensorValue == 0b11110000) {mappedValue = -60; obsKey = 1;}    //changed due to track from -60 to 0      
  else if (sensorValue == 0b11110000) mappedValue = -60;

  //Zigzag left turn
  else if (sensorValue == 0b01011000 || sensorValue == 0b11011000 || sensorValue == 0b11011100 || sensorValue == 0b01011100 ) {mappedValue = -70; acuteKey = -1;} 
