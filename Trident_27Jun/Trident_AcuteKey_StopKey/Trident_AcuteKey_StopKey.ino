...
{  
  ...
  //90 deg left turn
  else if (sensorValue == 0b11111000 || sensorValue == 0b11110000 || sensorValue == 0b11110000) {mappedValue = 0; acuteKey = 1;}    //changed due to track from -60 to 0      
...
{  
  ...
  //90 deg right turn
  else if (sensorValue == 0b11100000) mappedValue = 80;         
