...
int obsKey = 0; //triggers or stops sonar
...
{  
  ...
  //90 deg right turn
  if (sensorValue == 0b11100000 || sensorValue == 0b11110000) { mappedValue = 80; plannedCRotate(); delay(350);}         
  ...
  //90 deg left turn
  else if (sensorValue == 0b00000111 || sensorValue == 0b00001111) {mappedValue = -80; plannedACRotate(); delay(350);}   
...
void pingPulseComplete(unsigned long duration) {
  ...
  millimetres = MicrosecondsToMillimetres2 * duration/ 10;
